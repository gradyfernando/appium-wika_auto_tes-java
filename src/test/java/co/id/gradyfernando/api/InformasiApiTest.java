...
public class InformasiApiTest {
	...
	public static List<Informasi> getListInformasi(Jenis jenis, String token, String offset, String limit, String sifat, Map<String, String> additionalFilter) {
        ...
        switch (jenis) {
            case MASUK:
                apiUrl = Route.GET_LIST_INFORMASI_MASUK;
                break;
            case KELUAR:
                apiUrl = Route.GET_LIST_INFORMASI_KELUAR;
                break;
            default:
                break;
        }
		
        BaseResponseModel<BaseRecords<BaseDaftarSurat<Informasi>>> response = RestAssured
            .given()
            	.log().all()
            ...
            .then()
                ...
                .extract()
                .as(new TypeRef<BaseResponseModel<BaseRecords<BaseDaftarSurat<Informasi>>>>() {});
        
        List<Informasi> suratList = response.getData().getRecords().getData();
        return suratList;
	}
